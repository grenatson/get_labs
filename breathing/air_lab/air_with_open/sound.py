...
data0 = np.loadtxt("breathing/air_lab/air_with_open/data_0.txt")
data1 = np.loadtxt("breathing/air_lab/air_with_open/data_1.txt")
...
result = find_diff(data0, data1, ax2, label1="Микрофон №1", label2="Микрофон №2", tick=15)
...
fig.savefig("breathing/air_lab/air_with_open/data_processing.png")
plt.show()